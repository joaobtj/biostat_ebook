...
```{r anima, fig.cap="(ref:gganima)", gganimate=list(nframes=50), fig.path="image/"}
...
```{r anima2, fig.cap="(ref:gganima2)",fig.show="hold", gganimate=list(nframes=50), fig.path="image/"}
library(gapminder)
p <- gapminder %>%
