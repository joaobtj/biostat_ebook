...
tk_especie$emmeans %>%
  ...
  tab_footnote(footnote = "Médias seguidas por letras iguais não diferem entre si pelo teste de Tukey (p<0,05).",)
```
...
Em um desses estudos, os pesquisadores fizeram e suturaram uma incisão muscular profunda em ratos anestesiados e, então, associaram-nos aleatoriamente a um de cinco tratamentos. As feridas eram examinadas diariamente para se determinar o tempo (em dias) até sua completa cicatrização.

O arquivo [homeopatia.xlsx](data/homeopatia.xlsx)
