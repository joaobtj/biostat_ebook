...
### Variáveis derivadas
 ...
 A maior parte das variáveis são obtidas por meio de medidas e observações diretas. No entanto, há uma importante classe de variáveis denominadas derivadas, que são baseadas em duas ou mais medições obtidas independentemente. Alguns exemplos são: razão, porcentagem, índice e taxa.
...
Um agrônomo afirma que um novo fertilizante orgânico, em comparação com a marca líder, aumenta a produção e o tamanho dos tomates. Para o teste dessa afirmativa, plantas de tomate são associadas aleatoriamente a um de dois grupos: um grupo é cultivado com o fertilizante líder e o outro grupo, com o novo produto. Na época da colheita, registra-se o tamanho e a massa de cada tomate, juntamente com o total de tomates por planta. Os dados coletados desse experimento são usados para comparar os dois fertilizantes.
