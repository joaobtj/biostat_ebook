...
```{r popam, echo=FALSE, out.width="90%", fig.cap="População vs Amostra"}
knitr::include_graphics("image/pop-am.png")
```
...
```{r vinho, echo=FALSE}
knitr::include_graphics("image/vinho.jpg")
```
...
```{r tomate, echo=FALSE}
knitr::include_graphics("image/tomate.jpg")
```
...
```{r confund, echo=FALSE, out.width="90%"}
knitr::include_graphics("image/conf.png")
```
